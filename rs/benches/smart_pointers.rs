...
fn bench_access(c: &mut Criterion) {
    ...
    c.bench_function("access-refcell", |b| {
        b.iter(|| {
    ...
    c.bench_function("access-mutex", |b| {
        b.iter(|| {
    ...
    c.bench_function("access-rwlock_read", |b| {
        b.iter(|| {
    ...
    c.bench_function("access-rwlock_write", |b| {
        b.iter(|| {
