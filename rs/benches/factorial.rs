...
pub fn imperative_factorial_benchmark(c: &mut Criterion) {
    c.bench_function("imperative_factorial", |b| b.iter(|| imperative_factorial(black_box(UPPER_BOUND))));
}


pub fn recursive_factorial_benchmark(c: &mut Criterion) {
    c.bench_function("recursive_factorial", |b| b.iter(|| recursive_factorial(black_box(UPPER_BOUND))));
}

pub fn fold_factorial_benchmark(c: &mut Criterion) {
    c.bench_function("fold_factorial", |b| b.iter(|| fold_factorial(black_box(UPPER_BOUND))));
}


criterion_group!(factorial, 
